const holomemData = [
    ...
    { id: "Shirakami-Fubuki", name: "白上フブキ", disp: "<ruby>白上<rt>しらかみ</rt></ruby>フブキ", region: "JP", unit: "1期生", unitDisp: "1期生・ゲーマーズ" },
    ...
    { id: "Shirakami-Fubuki", name: "白上フブキ", disp: "<ruby>白上<rt>しらかみ</rt></ruby>フブキ", region: "JP", unit: "ゲーマーズ", unitDisp: "1期生・ゲーマーズ" },
    { id: "Ookami-Mio", name: "大神ミオ", disp: "<ruby>大神<rt>おおかみ</rt></ruby>ミオ", region: "JP", unit: "ゲーマーズ" },
    { id: "Nekomata-Okayu", name: "猫又おかゆ", disp: "<ruby>猫又<rt>ねこまた</rt></ruby>おかゆ", region: "JP", unit: "ゲーマーズ" },
    { id: "Inugami-Korone", name: "戌神ころね", disp: "<ruby>戌神<rt>いぬがみ</rt></ruby>ころね", region: "JP", unit: "ゲーマーズ" },
    ...
    { id: "Otonose-Kanade", name: "音乃瀬奏", disp: "<ruby>音乃瀬<rt>おとのせ</rt></ruby><ruby>奏<rt>かなで</rt></ruby>", region: "JP", unit: "ReGLOSS" },
    { id: "Ichijou-Ririka", name: "一条莉々華", disp: "<ruby>一条<rt>いちじょう</rt></ruby><ruby>莉々華<rt>りりか</rt></ruby>", region: "JP", unit: "ReGLOSS" },
    { id: "Juufuutei-Raden", name: "儒烏風亭らでん", disp: "<ruby>儒烏風亭<rt>じゅうふうてい</rt></ruby>らでん", region: "JP", unit: "ReGLOSS" },
    { id: "Todoroki-Hajime", name: "轟はじめ", disp: "<ruby>轟<rt>とどろき</rt></ruby>はじめ", region: "JP", unit: "ReGLOSS" },
    { id: "Hiodoshi-Ao", name: "火威青", disp: "<ruby>火威<rt>ひおどし</rt></ruby><ruby>青<rt>あお</rt></ruby>", region: "JP", unit: "ReGLOSS" },

    { id: "Isaki-Riona", name: "響咲リオナ", disp: "<ruby>響咲<rt>いさき</rt></ruby>リオナ", region: "JP", unit: "FLOW GLOW" },
    { id: "Koganei-Niko", name: "虎金妃笑虎", disp: "<ruby>虎金妃<rt>こがねい</rt></ruby><ruby>笑虎<rt>にこ</rt></ruby>", region: "JP", unit: "FLOW GLOW" },
    { id: "Mizumiya-Su", name: "水宮枢", disp: "<ruby>水宮<rt>みずみや</rt></ruby><ruby>枢<rt>すう</rt></ruby>", region: "JP", unit: "FLOW GLOW" },
    { id: "Rindo-Chihaya", name: "輪堂千速", disp: "<ruby>輪堂<rt>りんどう</rt></ruby><ruby>千速<rt>ちはや</rt></ruby>", region: "JP", unit: "FLOW GLOW" },
    { id: "Kikirara-Vivi", name: "綺々羅々ヴィヴィ", disp: "<ruby>綺々羅々<rt>ききらら</rt></ruby>ヴィヴィ", region: "JP", unit: "FLOW GLOW" },
